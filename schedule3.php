...
$output .= '
    <table width="100%" border="1" cellpadding="5" cellspacing="0">
                <tr>
                    <td colspan="16" align="center" style="font-size: 18px">
                        <b>' . $title . '</b>
                    </td>
                </tr>   
                <tr>
...
foreach ($data as $value) {
    ...
    foreach ($visit as $value2) {
        $age = $user->dateDiffYears(date('Y-m-d'), $value['dob']);
    ...
    $output .= '
            <tr>
                ...
                <td colspan="2">' . $value['ctc_number'] . '</td>
                <td colspan="2">' . $value['firstname'] . ' ' . $value['middlename'] . ' ' . $value['lastname'] . '</td>
                <td colspan="2">' . $value['dob'] . '</td>
                <td colspan="2">' . $age . '</td>
                <td colspan="2">' . $value['phone_number'] . '</td>
