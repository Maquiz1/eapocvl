...
if ($user->isLoggedIn()) {
    ...
    if ($client['client_image'] != '' || is_null($client['client_image'])) {
            ...
            <div class="card">
                ...
                <div class="card-body" id="mycard">
                    <div class='container' style='text-align:left; border:2px dotted black;'>
                        ...
                        <h1 style="float: right;width: 34vh;font-weight: bolder;margin-top: 10px;">EAPOC-VL-TRIAL</h1>
                        <div class='header'>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body" id="mycard1">
                    <div class='container' style='text-align:left; border:2px dotted black;'>
                        ...
                        <br>
                        <h4 style="text-align: center">Contact: +255 65 282 1433 , +255 74 682 1433</h4>
                    </div>
                </div>
                <hr>
